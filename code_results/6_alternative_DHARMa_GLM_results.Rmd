...
simpois %>%
  ...
  theme(panel.background = element_rect(color="black"))
ggsave(here('figures', '6_Pois_propzero.jpeg'), height=10, width=10)
```
...
simbin %>%
  ...
  theme(panel.background = element_rect(color="black"))
ggsave(here('figures', '6_Bin_propzero.jpeg'), height=10, width=10)
```
...
ggplot(aes(x=sampleSize, y=prop.sig, col=intercept, linetype=nSim,shape=nSim))+
  facet_grid(model~test, 
             labeller= as_labeller(c("Alt.p"= "Approximate Pearson residuals",
                                     "DHA.p" = "Sim-based residual variance",
  ...
  geom_hline(yintercept = 0.05, linetype = "dotted") 
ggsave(here('figures', '6_approxPearson_type1GLM.jpeg'), height=6, width=10)
```
...
ggsave(here('figures', '6_approxPearson_dispersionGLM.jpeg'), height=6, width=10)
```
...
ggsave(here('figures', '6_approxPearson_powerGLM.jpeg'), height=6, width=10)
```
